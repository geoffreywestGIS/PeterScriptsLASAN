...
gm = TlsSMTPHandler(("smtp.gmail.com", 587), 'geoffreywestgis@gmail.com', ['geoffreywestgis@gmail.com'], 'Peter Error West Valley found!', ('geoffreywestgis@gmail.com', 'pythonheat1'))
...
try:
    ...
    #Selection Query
    Harborselection = "CYLA_DISTRICT = 'WV' AND PlannedDate = CONVERT(DATE, GETDATE()) AND RESOLUTION_CODE <> '0' AND RESOLUTION_CODE IS NOT NULL AND RESOLUTION_CODE <> '-1'"
    ...
    send_to=['geoffreywestgis@gmail.com','sal.aguilar@lacity.org','maria.maldonado@lacity.org', 'nereida.santiago@lacity.org','ray.cruz@lacity.org','anabel.duran@lacity.org ','luis.lopez@lacity.org','kenneth.lampton@lacity.org']
