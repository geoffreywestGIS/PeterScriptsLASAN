...
try:
    ...
    PeterTable = "C:\PeterText.gdb\EVTable"
    Outable = "EVTable"
    ...
    #Selection Query
    Harborselection = "CYLA_DISTRICT = 'EV' AND PlannedDate = CONVERT(DATE, GETDATE()) AND RESOLUTION_CODE <> '0' AND RESOLUTION_CODE IS NOT NULL AND RESOLUTION_CODE <> '-1'"
    ...
    send_to=['geoffreywestgis@gmail.com','sal.aguilar@lacity.org','maria.maldonado@lacity.org','Pablo.Serrano@lacity.org','ronald.lee@lacity.org','jeff.browne@lacity.org', 'ron.lee@lacity.org', 'veronica.camacho@lacity.org', 'delia.diaz@lacity.org']
    subject ='EV Peter.Txt' + ' ' + date
