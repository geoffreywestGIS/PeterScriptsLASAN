...
gm = TlsSMTPHandler(("smtp.gmail.com", 587), 'geoffreywestgis@gmail.com', ['geoffreywestgis@gmail.com'], 'Peter Error Harbor found!', ('geoffreywestgis@gmail.com', 'pythonheat1'))
...
try:
    ...
    PeterTable = "C:\PeterText.gdb\HarborTable"
    Outable = "HarborTable"
    RoutePlannerTable = "RoutePlannerTable"
    ...
    #Selection Query
    Harborselection = "CYLA_DISTRICT = 'HB' AND PlannedDate = CONVERT(DATE, GETDATE()) AND RESOLUTION_CODE <> '0' AND RESOLUTION_CODE IS NOT NULL AND RESOLUTION_CODE <> '-1'"
    ...
    myOutputFile = open("C:\PeterScripts\Harbor\Peter.txt", 'w')
    rows = arcpy.da.SearchCursor("C:\PeterText.gdb\HarborTable", ["PtrText"])
    for row in rows:
    ...
    ATTACHMENTS = ["C:\PeterScripts\Harbor\Peter.txt"]
    send_from='geoffreywestgis@gmail.com'
    send_to=['geoffreywestgis@gmail.com','maria.maldonado@lacity.org', 'sal.aguilar@lacity.org', 'James.E.Moore@lacity.org','moniquea.mckee@lacity.org', 'daniel.lucero@lacity.org', 'luis.moreno@lacity.org']
    subject='Harbor Peter.Txt' + ' ' + date
