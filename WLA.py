...
try:
    ...
    #Selection Query
    Harborselection = "CYLA_DISTRICT = 'WLA' AND PlannedDate = CONVERT(DATE, GETDATE()) AND RESOLUTION_CODE <> '0' AND RESOLUTION_CODE IS NOT NULL AND RESOLUTION_CODE <> '-1'"
    ...
    ATTACHMENTS = ["C:\PeterScripts\WLA\Peter.txt"]
    send_from='geoffreywestgis@gmail.com'
    send_to=['geoffreywestgis@gmail.com','sal.aguilar@lacity.org', 'maria.maldonado@lacity.org', 'michael.jackson@lacity.org', 'larry.harper@lacity.org','daniel.mckay@lacity.org ', 'toni.chagolla@lacity.org', 'wayne.watson@lacity.org']
    subject ='WLA Peter.Txt' + ' ' + date
